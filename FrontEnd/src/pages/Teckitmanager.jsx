        ...
        <div className='relative'>
            ...
            {sellPop && (
                <div className='fixed inset-0 flex items-center justify-center z-[9999]'>
                    ...
                    <div className='flex flex-col items-center justify-evenly max-md:w-[80%] w-[40%] h-[40vh] bg-white rounded-[10px] z-[9999999] p-[20px]'>
                        ...
                        <input className='px-[10px] w-full max-w-[15rem] sm:max-w-[20rem] md:max-w-[25rem] h-[50px] rounded-l-[10px] border-[1px] border-[#78006E] placeholder-gray-500' placeholder="Buyer's Email" />
                        <button className=' rounded-r-[5px] text-white font-bold text-[1.2rem] py-2 px-9 bg-[#78006e] hover:bg-[#be008d]'>
                            Sell
                        </button>
                        </div>
            ...
            <div className='w-[100%] h-[40vh] relative  shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)]'>
                ...
                <div className='w-[60%] max-md:w-[80%] h-[30%] flex max-md:flex-col-reverse max-md:justify-center gap-y-[10px] justify-between items-center bg-white rounded-[10px] absolute bottom-0 left-[50%] translate-x-[-50%]'>
                    <div className='w-[40%] max-md:w-[100%] pl-4 max-md:pl-0 justify-evenly flex gap-x-[1.5rem] font-bold'>
                        <button className='px-[16px] h-[40px] rounded-[10px] bg-[] hover:text-[#78006E]' onClick={() => handleFilter(0)}>Available</button>
                        <button className='px-[5px] h-[40px] rounded-[10px] bg-[] hover:text-[#78006E]'onClick={() => handleFilter(1)}>Not available</button>

                    </div>
                    <div className='w-[60%] max-md:w-[100%] max-md:justify-center flex justify-end max-md:pr-0 pr-4'>
                        <input className='w-[80%] h-[40px] rounded-l-[10px] max-md:h-[50px] border-[1px] border-[#78006E] px-[10px] focus:outline-none'  type='search'></input>
            ...
            {tickets.map((ticket,index) => (
                    <MyTicket
                        ...
                        process='Sell'
                        popSellForm={() => handleSell(ticket.code)}
                    />
                ))}
                {/* <MyTicket
                    title='WWE RAW'
