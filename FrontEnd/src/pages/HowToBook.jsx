import { FaDoorOpen, FaTicketAlt, FaCreditCard, FaMapMarkerAlt } from "react-icons/fa";
...
const HowToBook = () => {
  return (
    <div className="container mx-auto py-28">
      <h2 className="text-3xl font-bold text-purple-900 px-8 mb-6 text-left p-9">How to Book Your Ticket?</h2>
      <br />
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 text-center">
        <div>
          <FaDoorOpen className="w-12 h-12 mx-auto mb-2 text-gray-900" />
          <h3 className="text-xl p-9">Enter the Event</h3>
        </div>
        <div>
          <FaTicketAlt className="w-12 h-12 mx-auto mb-2 text-gray-900" />
          <h3 className="text-xl p-9">Receive Your Ticket</h3>
        </div>
        <div>
          <FaCreditCard className="w-12 h-12 mx-auto mb-2 text-gray-900" />
          <h3 className="text-xl p-9">Make Payment</h3>
        </div>
        <div>
          <FaMapMarkerAlt className="w-12 h-12 mx-auto mb-2 text-gray-900" />
