...
if(idNumber.length==0){
  newErrors.idNumber = 'يجب تعبئة الحقل';
    ...
    if (Object.keys(newErrors).length > 0) {
      ...
      setErrors('');
      // إرسال البيانات (أضف الكود الخاص بإرسال البيانات هنا)
        ...
        >
          ...
          <div className=" flex flex-col justify-center p-8 text-right ">
            ...
            {/* <div>
              ...
              <button type="submit" className="bg-[#78006E] text-white rounded-full p-2 w-[80%] hover:bg-black hover:text-white " onClick={navigate('/login')}>تسجيل</button>
              </div>
            </form>
            <div className="mt-4">
