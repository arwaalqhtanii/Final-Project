...
//     //         const approveResponse = await axios.put(`http://localhost:8050/notifications/approve/${notificationID}`, {}, {
//     //             headers: {
//     //                 Authorization: `Bearer ${token}`,
//     //             },
//     //         });
    
//     //         // Log the response from the approval endpoint
//     //         console.log("Approval Response:", approveResponse.data);
    
//     //         setShowSuccessMessage(true);
//     //         console.log("Purchase approved!");

//     //         // Step 3: Track and suspend the user
//     //         const suspendResponse = await axios.post('http://localhost:8050/notifications/track-and-suspend', {
//     //             userId: userId,
//     //         });
...
//     //         if (suspendResponse.status !== 200) {
//     //             throw new Error('Error tracking and suspending user');
//     //         }
//     //     } catch (error) {
...
//             // Handle navigation based on suspension status
//             if (suspendResponse.data.message) {
//                 alert(suspendResponse.data.message.include("suspended"));
//                 // Navigate to the login page
//                 navigate('/login');
//             } else {
//                 // Navigate to the ticket manager
//                 navigate('/Teckitmanager');
//             }
//         } catch (error) {
//             alert('An error occurred: ' + error.message);
